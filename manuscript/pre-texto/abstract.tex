...
A smart city \ac{PTN} provides mobility services to millions of people daily. 
...
Regarding the PTN, many methods rely on two specifications: \ac{GTFS} and \ac{GTFS-RT}. The first represents the static schedule information, and the second introduces real-time updates from trips, services, and vehicle positions. Despite the qualitative leap with the GTFS-RT specification, GTFS-RT
